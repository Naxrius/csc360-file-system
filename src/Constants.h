...
// ****Positions of things in the FAT


// ****Sizes of FILE/FAT things (Added)
#define IDENT_SIZE 8
#define BLOCKSIZE_SIZE 2
#define BLOCKCOUNT_SIZE 4
#define FATSTART_SIZE 4
#define FATBLOCKS_SIZE 4
#define ROOTDIRSTART_SIZE 4
#define ROOTDIRBLOCKS_SIZE 4

// ****Sizes of DIRECTORY ENTRY things (Added)
#define ENT_STATUS_SIZE 1
#define ENT_START_BLOCK_SIZE 4
#define ENT_NUM_BLOCKS_SIZE 4
#define ENT_FILESIZE_SIZE 4
#define ENT_CREATE_TIME_SIZE 7
#define ENT_MOD_TIME_SIZE 7
#define ENT_FILE_NAME_SIZE 31
